# Workshop: DJ Mixing Deck - Customization - Metadata

## Target Audience

**Primary Audience**: High school students (ages 14-18) who have completed the DJ Mixing Deck Starter workshop.
...
**Accessibility**: This workshop builds on the DJ Mixing Deck Starter. Students should have a working DJ deck before adding customization features. The goal is to introduce file upload functionality and user customization.
...
- Understanding customization goals
- Review of DJ Mixing Deck Starter concepts
...
- ✅ Handle audio file uploads and use them in the DJ deck
- ✅ Replace existing assets with user-uploaded files
- ✅ Understand file type restrictions and validation
- ✅ Create a customizable DJ deck that users can personalize
- ✅ Handle edge cases in file uploads
- ✅ Read and use documentation for file handling
